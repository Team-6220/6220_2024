...
// public class ShootAndPickUpFarNoteTesting extends SequentialCommandGroup {
...
//   public ShootAndPickUpFarNoteTesting(Swerve s_Swerve) {
...
//       AutoBuilder.pathfindToPose(AutoConstants.NEARNOTE_POSE2DS[0], AutoConstants.pathConstraints, bufferVelocityForIntake),
//       new IntakeCommand(s_Swerve),
//       new SpeakerCommand(s_Swerve),
//       AutoBuilder.pathfindToPose(AutoConstants.MULTITARGETPOSES_FORINTAKECAMERA[0], AutoConstants.pathConstraints, bufferVelocityForIntake, 1),
//       new IntakeCommand(s_Swerve),
