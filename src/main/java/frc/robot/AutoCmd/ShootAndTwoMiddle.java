...
// public class ShootAndTwoMiddle extends SequentialCommandGroup {
...
//   public ShootAndTwoMiddle(Swerve s_Swerve) {
//     // Pose2d firePose = new Pose2d(AlienceColorCoordinateFlip.flip(1.6), 6.25, new Rotation2d(Rotation2d.fromDegrees(AlienceColorCoordinateFlip.flipDegrees(-165)).getRadians()));
...
//       AutoBuilder.pathfindToPose(AutoConstants.NEARNOTE_POSE2DS[1], AutoConstants.pathConstraints, bufferVelocityForIntake),
//       new IntakeCommand(s_Swerve),
//       new SpeakerCommand(s_Swerve),
//       AutoBuilder.pathfindToPose(AutoConstants.MULTITARGETPOSES_FORINTAKECAMERA[1], AutoConstants.pathConstraints, bufferVelocityForIntake, 1),
//       new IntakeCommand(s_Swerve),
//       Commands.deadline(AutoBuilder.pathfindToPose(AutoConstants.middleShootingPose, AutoConstants.pathConstraints, bufferVelocityForShoot), new AutoSystemsPrep(AutoConstants.middleShootingPose, s_Swerve)),
//       new SpeakerCommand(s_Swerve),
