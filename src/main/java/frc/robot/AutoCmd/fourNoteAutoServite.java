...
public class fourNoteAutoServite extends SequentialCommandGroup {
  ...
  public fourNoteAutoServite(Swerve s_Swerve) {
    ...
    addCommands(
      ...
      new SpeakerCommand(s_Swerve),
      AutoBuilder.pathfindToPose(new Pose2d(AlienceColorCoordinateFlip.flip(1.9), 5.6, Rotation2d.fromDegrees(AlienceColorCoordinateFlip.flipDegrees(180))), AutoConstants.pathConstraints, 2),
      ...
      AutoBuilder.pathfindToPose(new Pose2d(AlienceColorCoordinateFlip.flip(1.9),6.6, new Rotation2d((Math.PI/180)*AlienceColorCoordinateFlip.flipDegrees(-150))), AutoConstants.pathConstraints,2),
