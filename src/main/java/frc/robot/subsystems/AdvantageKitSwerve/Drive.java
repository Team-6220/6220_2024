...
public class Drive extends SubsystemBase {
  ...
  private SwerveDrivePoseEstimator poseEstimator =
      new SwerveDrivePoseEstimator(SwerveConstants.swerveKinematics, rawGyroRotation, lastModulePositions, new Pose2d());
  ...
  public void periodic() {
    ...
    if (gyroInputs.connected) {
      ...
      Twist2d twist = SwerveConstants.swerveKinematics.toTwist2d(moduleDeltas);
  ...
  public void runVelocity(ChassisSpeeds speeds) {
    ...
    SwerveModuleState[] setpointStates = SwerveConstants.swerveKinematics.toSwerveModuleStates(discreteSpeeds);
  ...
  public void stopWithX() {
    ...
    SwerveConstants.swerveKinematics.resetHeadings(headings);
    stop();
  }
