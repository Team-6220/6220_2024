...
public class PhotonvisionCalculations {
    ...
    camTrustValue)
    {
        ...
        if(camNumerator > 0)
        {
            ...
            poseEstimator.addVisionMeasurement(weightedEstimatePose, avgTimeStamp );//addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds, Matrix<N3,N1> visionMeasurementStdDevs) : void
        }
